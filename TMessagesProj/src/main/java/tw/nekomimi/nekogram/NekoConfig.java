...
public class NekoConfig {
    ...
    public static ConfigItem allowScreenshots = addConfig("allowScreenshots", configTypeBool, false);

    // ── ميزة ٢: Forward bypass
    public static ConfigItem bypassNoForwards = addConfig("bypassNoForwards", configTypeBool, false);

    // ── ميزة ٣: Deleted Messages
    public static ConfigItem saveDeletedMessages = addConfig("saveDeletedMessages", configTypeBool, false);

    // ── ميزة ٦: Regex Filters
    public static ConfigItem enableFilters = addConfig("enable_filters", configTypeBool, false);

    // ── ميزة ٧: History Forwarder
    public static ConfigItem enableForwardHistory = addConfig("enableForwardHistory", configTypeBool, true);
