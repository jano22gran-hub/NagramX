...
public class NekoSettingsActivity extends BaseNekoSettingsActivity {
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        ...
        } else if (position == forwarderRow) {
            presentFragment(new org.telegram.messenger.NagramX.forwarder.ForwarderSettingsActivity());
            ...
            switch (viewType) {
                ...
                case TYPE_TEXT: {
                    ...
                    if (position == chatRow) {
                        ...
                        textCell.setTextAndIcon("إعدادات التحويل 🔄", R.drawable.msg_forward, true);
                    } else if (position == importSettingsRow) {
